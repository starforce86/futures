...
class DetailOldController extends Controller
{
    ...
    public function join(Request $request, $id) {
        ...
        if ($action == 'REQUEST') {
            ...
            return redirect()->route('tribe.detail.join_requests.old', ['id' => $tribe->id]);
        }

        return redirect()->route('tribe.detail.old', ['id' => $tribe->id]);
    }
    ...
    public function invite(Request $request, $id) {
        ...
        return redirect()->route('tribe.detail.invites.old', ['id' => $tribe->id]);
    }
