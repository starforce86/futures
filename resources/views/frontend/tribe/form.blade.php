    ...
    <div class="card-body">
        <form id="tribe_create_form" action="{{ !empty($tribe->id)?route('tribe.detail.edit', ['id' => $tribe->id]):route('tribe.create') }}" method="post">
            ...
            <div class="form-group">
                <label for="tribe_title" class="label-tribe-name">Name of your tribe</label>
            ...
            <!-- Description -->
            <div class="form-group">
                <label for="tribe_description" class="label-tribe-summary">Summary</label>
            ...
            <!-- Location -->
            <div class="form-group">
                <label for="tribe_location" class="label-tribe-location">Location</label>
                <input type="text" class="form-control input-tribe-location" id="tribe_location" name="tribe[location]" placeholder="Area ex. Sydney" required value="{{ $tribe->location }}">
            </div>

            <!-- Topic -->
            <div class="form-group">
                <label for="tribe_topic_id" class="d-block label-tribe-topic">Topic</label>
            ...
            <!-- Image -->
            <div class="form-group">
                <label class="control-value-avatar label-tribe-cover">Upload a cover image</label>
